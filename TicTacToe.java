...
public class TicTacToe {
    public static void main(String[] args) {
        ...
        while (true) { // game is not over
            ...
            // while loop to do the sanity check for valid row and column
            while (true) {
            ...
            player1 = !player1; // switch between player 1 and player 2 player1 = ! true = false we switch to player 2
        }
